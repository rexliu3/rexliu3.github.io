...
export function Icon({ name, size = 20, ...props }) {
  const paths = {
    ...
    laptop: <><rect x="5" y="4" width="14" height="12" rx="1"/><path d="m5 16-3 4h20l-3-4M10 18h4"/></>,
    music: <><path d="M9 18V5l11-2v13M9 9l11-2"/><ellipse cx="6" cy="18" rx="3" ry="2"/><ellipse cx="17" cy="16" rx="3" ry="2"/></>,
    camera: <><path d="M3 7h4l2-3h6l2 3h4v13H3Z"/><circle cx="12" cy="13" r="4"/></>,
    diploma: <><rect x="3" y="4" width="18" height="15" rx="1"/><path d="M7 8h10M8 11h8m-7 8-1 3 4-2 4 2-1-3"/><circle cx="12" cy="15" r="2"/></>,
  ...
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>{paths[name] || paths.home}</svg>;
}
