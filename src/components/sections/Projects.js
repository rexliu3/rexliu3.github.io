    ...
    <div className="projects">
      <h1 className="projects__header">Projects</h1>
        ...
        <div className="projects__grid">
          ...
          <Project data={["AI Stock Trading Bot", "assets/StockBot.png", ["Implemented Alpaca Trading API to import data and create buy/sell orders", "Designed AI software to predict the movement of stocks based on past data and current trends; creates buy/sell orders accordingly", "", "Uploaded program to Google Cloud Storage to run infinitely on Google Cloud", "Developed with Keras, Sklearn, Numpy, Pandas, and threading"], "Python, Keras, Sklearn, Numpy, Pandas, Google Cloud Platform", "https://github.com/rexliu3/StockTradingBotCloud", "May 2020 - Jun 2020"]} />
          <Project data={["Senior House Connect", "assets/SeniorConnect.jpg", ["Creating web application for senior homes to match volunteers with seniors for one-on-one sessions", "Designing user-interface for volunteers to input preferences and for volunteer managers to manage senior and volunteers", "Implementing MySQL database to store preferences of volunteers and seniors", "Developing unique algorithm to match seniors to volunteers based on preferences", ""], "HTML, CSS, JavaScript, MySQL", "https://github.com/rexliu3/LocationBasedActions", "Apr 2020 – May 2020"]} />
          <Project data={["Sorting Visualizer", "assets/Sorting.png", ["Visualize merge, quick, heap, and bubble sort algorithms", "Developed user-interface to randomize and sort arrays with React library", "", "", ""], "JavaScript, ReactJS", "https://github.com/rexliu3/sorting_visualizer", "May 2020 - PRESENT"]} />
          <Project data={["Location Based Notifications", "assets/Location.jpg", ["Designed application that sends notifications when user enters pre-set radiuses", "Implemented geofences to track user location near a center address", "Created user-interface to input address, radius, and duration", "Published to Google Play Store", ""], "Java, XML, Geofences, Android Studio", "https://github.com/rexliu3/StockTradingBotCloud", "May 2020 - Jun 2020"]} />
          <Project data={["Sudoku Game and Solver", "assets/NoImage.png", ["Developed playable Sudoku game GUI with Python and the PyGame module", "Designed Sudoku board solver to visualize backtracking algorithm", "Created timer and incorrect move counter", "", ""], "Python, PyGame, Algorithms", "https://github.com/rexliu3/sudoku-solver", "May 2020"]} />
